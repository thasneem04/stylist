    ...
    result = result.filter((item) => {
      return (
        ...
        (filters.color === "all" ||
          ...
          item.colors?.includes(filters.color)) &&
        (filters.size === "all" ||
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        ...
        <div className="flex flex-wrap items-center gap-4 w-full md:w-auto">
          ...
          >
            <option value="recommended" className="bg-primary">
              Recommended
            </option>
            <option value="price-low" className="bg-primary">
              Price: Low to High
            </option>
            <option value="price-high" className="bg-primary">
              Price: High to Low
            </option>
            <option value="rating" className="bg-primary">
              Highest Rated
            </option>
          </select>
        ...
        >
          <div className="glass-card sticky top-32 space-y-8 p-5 sm:p-6 lg:top-24">
              ...
              <div className="flex flex-col gap-2">
                {categories.map((c) => (
                  ...
                  >
                    ...
                    />
                    <div
                      className={`w-4 h-4 rounded-full border border-white/30 flex items-center justify-center ${filters.category === c ? "bg-accent border-accent" : "group-hover:border-accent"}`}
                    >
                      {filters.category === c && (
                    ...
                    <span
                      className={`text-sm capitalize ${filters.category === c ? "text-white font-bold" : "text-gray-400"}`}
                    >
                      {c}
                    </span>
                  </label>
              ...
              <div className="flex flex-wrap gap-2">
                {colors.map((c) => (
                  <button
                    ...
                    style={{
                      backgroundColor: c === "all" ? "transparent" : c,
                      backgroundImage:
                        c === "all"
                          ? "linear-gradient(45deg, #ff007f, #8a2be2)"
                          : "none",
                    }}
                    title={c}
                  >
            ...
            <div>
              ...
              >
                {occasions.map((o) => (
                  <option key={o} value={o} className="bg-primary">
                    {o}
                  </option>
                ))}
              </select>
