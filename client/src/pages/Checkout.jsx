...
const checkoutInputClass =
  "w-full bg-white border border-gray-300 rounded-lg p-3 text-gray-950 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent";
      ...
      <div className="min-h-[70vh] bg-white text-gray-900 flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-gray-500 mb-8">
            Thank you for your purchase. Your order {placedOrderId} has been
            successfully placed.
          </p>
            ...
            <form onSubmit={handlePayment} className="space-y-6 sm:space-y-10">
              ...
              <section className="bg-white p-4 sm:p-8 rounded-xl border border-gray-100 shadow-sm text-gray-950">
                <h2 className="mb-5 flex items-center gap-2 text-lg font-black uppercase tracking-tight text-gray-950 sm:mb-6 sm:text-xl">
                  <span className="bg-black text-white w-7 h-7 rounded-full flex items-center justify-center text-xs">
                    1
                  </span>
                  Shipping Details
                </h2>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <input
                    ...
                    onChange={(e) =>
                      updateShippingDetails("fullName", e.target.value)
                    }
                    placeholder="Full Name"
                    className={`sm:col-span-2 ${checkoutInputClass}`}
                  />
                  <input
                    required
                    type="text"
                    ...
                    onChange={(e) =>
                      updateShippingDetails("address", e.target.value)
                    }
                    placeholder="Address"
                    className={`sm:col-span-2 ${checkoutInputClass}`}
                  />
                  <input
                    ...
                    onChange={(e) =>
                      updateShippingDetails("city", e.target.value)
                    }
                    placeholder="City"
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateShippingDetails("zip", e.target.value)
                    }
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateShippingDetails("phone", e.target.value)
                    }
                    ...
                    >
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`${paymentInputClass} pl-10`}
                        />
                      </div>
                      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <input
                    ...
                    >
                      <div className="rounded-lg border border-dashed border-gray-300 bg-gray-50 p-4 text-center sm:p-6">
                        ...
                        <p className="text-sm text-gray-700 mb-4 font-medium">
                          {
                            upiProviders.find(
                              (provider) => provider.id === upiProvider,
                            )?.label
                          }{" "}
                          selected. Tap the payment app above to open it, or
                          enter your UPI ID to receive a payment request.
                        </p>
                        <input
                          type="text"
                          placeholder="yourname@okaxis"
                          className={`${paymentInputClass} max-w-xs text-center`}
                        />
                      </div>
                    </motion.div>
                  )}
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-800/70 mt-1 leading-relaxed">
                          ...
                          delivery. A verification call will be made before
                          dispatch.
                        </p>
                      </div>
                    </motion.div>
          ...
          <div className="w-full lg:w-96 flex-shrink-0">
            <div className="sticky top-32 rounded-xl border border-gray-100 bg-white p-4 text-gray-950 shadow-sm sm:p-8 lg:top-24">
                  ...
                  <div key={item._id} className="flex items-center gap-4 group">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500 font-medium mt-1">
                        {item.selectedSize || "Free Size"} / {item.color} • Qty{" "}
                        {item.quantity}
                      </p>
                      <p className="text-sm font-black mt-1 text-gray-950">
                        ₹
                        {(
                          item.price *
              ...
              <div className="flex justify-between items-end text-xl font-black text-gray-900">
                <span className="uppercase text-xs tracking-[0.2em] mb-1">
                  Total Pay
                </span>
